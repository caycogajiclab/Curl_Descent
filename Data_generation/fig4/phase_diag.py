...
# Save using pickle
with open(f'/shared/projects/project_curlDynamics/clean_code/normalized/phase_diag_L2/run_{nb_AH_layer1}-{input_dim}__{nb_AH_layer2}-{student_size}__{task_id}.pkl', 'wb') as f:

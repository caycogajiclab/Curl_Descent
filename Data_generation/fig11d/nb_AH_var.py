...
# Save using pickle
with open(f'/shared/projects/project_curlDynamics/clean_code/not_normalized/rebuttal/nb_AH_var/run_{nonlinearity}_{initialization_type}_{task_id}.pkl', 'wb') as f:
